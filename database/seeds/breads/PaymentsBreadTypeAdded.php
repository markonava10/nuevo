...
class PaymentsBreadTypeAdded extends Seeder
{
    /**
    ...
    public function run()
    {
        try {
            ...
            $dataType = DataType::where('name', 'payments')->first();
            ...
            if ($dataType) {
                DataType::where('name', 'payments')->delete();
            }
            ...
            Voyager::model('Permission')->generateFor('payments');
