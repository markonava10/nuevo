...
class TransactionsBreadTypeAdded extends Seeder
{
    /**
    ...
    public function run()
    {
        try {
            ...
            if ($dataType) {
                DataType::where('name', 'transactions')->delete();
            }
            ...
            \DB::table('data_types')->insert(array (
                ...
                'created_at' => '2020-09-09T02:44:01',
                'updated_at' => '2020-09-17T17:52:08',
            ));

            
            

            Voyager::model('Permission')->generateFor('transactions');
