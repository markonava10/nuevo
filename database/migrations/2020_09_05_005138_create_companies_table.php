...
class CreateCompaniesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('companies', function (Blueprint $table) {
            ...
            $table->integer('providers_transfers,2')->default(2);
            $table->integer('days_providers_transfers,2')->default(10);

            $table->integer('providers_exchanges,2')->default(2);
            $table->integer('days_providers_exchanges,2')->default(10);
