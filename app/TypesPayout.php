...
use Auth;
class TypesPayout extends Model
{
    // Generales
	protected $table = 'types_payouts';
    ...
    */
    ...
    /*+----------------------------------------------------------+
      ...
      +----------------------------------------------------------+
    */
    // Types_Payments --> Payouts  (Un tipo de servicio tiene muchos pagos)
    public function payouts(){
        return $this->hasMany(Payout::class,'types_payout_id','id');
    }
    ...
    */
    ...
    // Un Tipo de pago (Types_Payout) puede ser usado por muchas empresas 
